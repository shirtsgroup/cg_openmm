...
for polymer_length in [10,20,30,50,100]:
 ...
 for backbone_lengths in [[1],[2],[3],[4],[5]]:
  ...
  for sidechain_lengths in [[1],[2],[3],[4],[5]]:
   ...
   for sidechain_positions in [[i] for i in range(backbone_lengths[0])]:
    ...
    cg_model = CGModel(polymer_length=polymer_length,backbone_lengths=backbone_lengths,sidechain_lengths=sidechain_lengths,sidechain_positions=sidechain_positions,include_torsion_forces=False)
exit()
