...
# Job settings
top_directory = 'unfold_test_output'
...
for sigma in sigma_list: 
 for epsilon in epsilon_list:
  print("Using sigma values of "+str(sigma)+" and epsilon values of "+str(epsilon))
  ...
  positions = PDBFile("pose_2.pdb").getPositions()
