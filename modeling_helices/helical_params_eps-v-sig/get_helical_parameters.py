...
for sigma in sigma_list:
 for epsilon in epsilon_list:
  ...
  minimum_energy_structure = get_native_structure(replica_positions,replica_energies,temperature_list)
  ...
  data.write(str(round(sigma._value,3))+" "+str(round(epsilon._value,3))+" "+str(round(float(pitch),3))+" "+str(round(float(radius),3))+" "+str(round(float(monomers_per_turn),3))+" "+str(round(float(residual),3))+"\n")
  data.close()
