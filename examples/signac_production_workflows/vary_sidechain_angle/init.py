...
project = signac.init_project('signac_vary_sidechain_theta')
...
equil_bond_angle_bb_bb_sc = [120.0, 122.5, 125.0, 127.5, 130.0, 132.5, 135.0, 137.5, 140.0] # Original constraint was 127.5
...
# For varying sidechain angle:
for theta in equil_bond_angle_bb_bb_sc:
    sp = {
        ...
        'equil_bond_angle_bb_bb_sc': theta,
        'k_torsion': k_torsion,
