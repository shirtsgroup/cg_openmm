...
def run_replica_exchange(verbose=False, verbose_simulation=False):
    ...
    K = 400.0 * unit.kilocalories_per_mole / unit.angstroms**2  # Spring constants.
    ...
    if os.getcwd() == os.getcwd():   
        ...
        if np.any(nsigma > MAX_SIGMA):
            ...
            print("nsigma")
            print(nsigma)
            print("WARNING: Dimensionless free energy difference exceeds MAX_SIGMA of %.1f" % MAX_SIGMA)
        ...
        if np.any(nsigma > MAX_SIGMA):
            ...
            print("nsigma")
            print(nsigma)
            print("WARNING: Dimensionless potential energy difference exceeds MAX_SIGMA of %.1f" % MAX_SIGMA)
