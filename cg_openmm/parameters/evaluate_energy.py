...
def eval_energy(cgmodel, file_list, temperature_list, param_dict,
    ...
    :type param_dict: dict{'param_name': [start, end, step] * simtk.unit}
    ...
    for i in range(len(file_list)):
        ...
        if i == 0:
            ...
            U = np.zeros((len(file_list),len(file_list),nframes))
        ...
        for k in range(nframes):
            ...
            # file, but organized by state rather than replica in the first dimension.
